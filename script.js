document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (isFinite(maxLength) && value.length > maxLength) {
    ...
    contactForm.addEventListener('input', function (e) {
      const field = e.target.closest('input, textarea, select');
      if (field && field.classList.contains(FIELD_ERROR_CLASS)) {
        validateField(field);
      }
    });
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "יניב וידס | Vidas נדל\"ן משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '8762326e-b146-4a43-8a4a-b47a84ea143f',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '8762326e-b146-4a43-8a4a-b47a84ea143f';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '8762326e-b146-4a43-8a4a-b47a84ea143f';
